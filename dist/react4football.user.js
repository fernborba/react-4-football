...
// @require      https://raw.githubusercontent.com/fernborba/react-4-football/refs/heads/main/dist/index4.js?v=v7.7.14
// ==/UserScript==
...
body{background-position:center;background-color:#191820;background-repeat:no-repeat;background-size:cover;color:#fcfcfc;font-family:UltimateTeam,sans-serif;font-size:100%;outline:0;position:relative}.field-label{margin-right:.5rem}.r4f-market-btn{background:#1f1f1f;border:1px solid #444;padding:10px 16px;border-radius:6px;cursor:pointer;color:#fff;font-weight:600;transition:background .2s ease}.r4f-floating-btn{position:fixed;top:40px;left:250px;z-index:9999999;background:#1f1f1f;border:1px solid #444;padding:10px 16px;border-radius:6px;cursor:pointer;color:#fff;font-weight:600;transition:background .2s ease}.r4f-floating-btn:hover{background:#333}.r4f-shell{position:fixed;top:88px;right:18px;z-index:2147483000;pointer-events:none}.r4f-launcher,.r4f-panel-item{font-family:UltimateTeam,sans-serif}.r4f-launcher{pointer-events:auto;min-width:150px;padding:12px 16px;border:1px solid rgba(255,255,255,.18);border-radius:18px;background:linear-gradient(180deg,#2a2c3af5,#141621fa);box-shadow:0 14px 34px #00000057;color:#f6f7fb;display:flex;flex-direction:column;align-items:flex-start;gap:2px;cursor:pointer;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);transition:transform .15s ease,border-color .15s ease,filter .15s ease}.r4f-launcher:hover{transform:translateY(-1px);border-color:#ffffff52;filter:brightness(1.05)}.r4f-launcher-title{font-size:1rem;line-height:1.1}.r4f-launcher-subtitle{font-size:.74rem;color:#ffffffb8}.r4f-panel{pointer-events:auto;position:absolute;top:64px;right:0;width:min(340px,calc(100vw - 24px));padding:12px;border:1px solid rgba(255,255,255,.12);border-radius:22px;background:#0e1019f5;box-shadow:0 24px 60px #0000006b;display:flex;flex-direction:column;gap:10px;-webkit-backdrop-filter:blur(16px);backdrop-filter:blur(16px)}.r4f-panel-item{width:100%;-webkit-appearance:none;-moz-appearance:none;appearance:none;padding:14px 16px;border:1px solid rgba(255,255,255,.08);border-radius:16px;color:#f5f5f5;display:flex;flex-direction:column;align-items:flex-start;gap:4px;text-align:left;line-height:1.15;cursor:pointer;transition:transform .15s ease,border-color .15s ease,filter .15s ease}.r4f-panel-item:hover{transform:translateY(-1px);border-color:#ffffff38;filter:brightness(1.05)}.r4f-panel-item-title{font-size:.98rem}.r4f-panel-item-copy{font-size:.76rem;color:#ffffffc2}.r4f-tool-search{background:linear-gradient(180deg,#383838,#222)}.r4f-tool-sbc{background:linear-gradient(180deg,#313131,#1f1f1f)}.r4f-tool-daily{background:linear-gradient(180deg,#3b9647,#266333)}.r4f-tool-mixed{background:linear-gradient(180deg,#63b5ff,#3279c7)}.r4f-tool-premium{color:#1a1a1a;background:linear-gradient(180deg,#ffe169,#f8c933)}.r4f-tool-sell{background:linear-gradient(180deg,#ff8f6b,#d45733)}@media screen and (max-width: 1280px){.r4f-shell{top:76px;right:10px}.r4f-launcher{min-width:132px;padding:11px 13px}.r4f-panel{top:58px;width:min(300px,calc(100vw - 20px))}}@media screen and (max-width: 720px){.r4f-shell{top:auto;right:10px;bottom:10px}.r4f-panel{top:auto;right:0;bottom:58px;width:min(320px,calc(100vw - 20px))}}.r4f-ai-panel{position:fixed;top:88px;right:186px;z-index:2147482999;pointer-events:none}.r4f-ai-card,.r4f-ai-btn,.r4f-ai-field input,.r4f-ai-field select,.r4f-ai-field textarea{font-family:UltimateTeam,sans-serif}.r4f-ai-card{width:min(290px,calc(100vw - 32px));pointer-events:auto;padding:12px;border:1px solid rgba(255,255,255,.12);border-radius:18px;background:#1e1e1ee6;box-shadow:0 16px 44px #0000005c;-webkit-backdrop-filter:blur(12px);backdrop-filter:blur(12px);display:flex;flex-direction:column;gap:10px;color:#f3f4f6}.r4f-ai-header{display:flex;align-items:center;justify-content:space-between;gap:10px}.r4f-ai-title{font-size:14px;font-weight:700;letter-spacing:.02em}.r4f-ai-status{font-size:11px;color:#ffffffb8;text-transform:uppercase;letter-spacing:.08em}.r4f-ai-status-live{color:#9ae6b4}.r4f-ai-form,.r4f-ai-details{display:flex;flex-direction:column;gap:9px}.r4f-ai-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.r4f-ai-field{display:flex;flex-direction:column;gap:4px;font-size:11px;color:#ffffffb8}.r4f-ai-field input,.r4f-ai-field select,.r4f-ai-field textarea{width:100%;box-sizing:border-box;border:1px solid rgba(255,255,255,.1);border-radius:10px;background:#090b10d1;color:#f8fafc;font-size:13px;padding:9px 10px;resize:vertical}.r4f-ai-field select{-webkit-appearance:none;-moz-appearance:none;appearance:none}.r4f-ai-field input::placeholder,.r4f-ai-field textarea::placeholder{color:#ffffff57}.r4f-ai-detail{display:flex;flex-direction:column;gap:3px}.r4f-ai-label{font-size:11px;color:#ffffff94;text-transform:uppercase;letter-spacing:.06em}.r4f-ai-value{font-size:13px;line-height:1.3;color:#f8fafc;word-break:break-word}.r4f-ai-meta{display:flex;flex-wrap:wrap;gap:8px 12px;font-size:11px;color:#ffffffb8}.r4f-ai-btn{border:1px solid transparent;border-radius:11px;padding:10px 12px;color:#fff;font-size:12px;font-weight:700;cursor:pointer;transition:filter .15s ease,transform .15s ease,border-color .15s ease}.r4f-ai-btn:hover:not(:disabled){transform:translateY(-1px);filter:brightness(1.04)}.r4f-ai-btn:disabled{opacity:.55;cursor:not-allowed}.r4f-ai-btn-inline{padding:7px 10px}.r4f-ai-btn-start{background:linear-gradient(180deg,#2f9d57,#1f6f3d)}.r4f-ai-btn-end{background:linear-gradient(180deg,#b44b4b,#7f2d2d)}.r4f-ai-btn-neutral{background:linear-gradient(180deg,#555b66,#3d434d)}.r4f-ai-error{border:1px solid rgba(244,114,114,.2);border-radius:10px;padding:8px 10px;background:#7f1d1d38;color:#fda4af;font-size:12px}@media screen and (max-width: 1280px){.r4f-ai-panel{top:76px;right:152px}}@media screen and (max-width: 900px){.r4f-ai-panel{top:150px;right:10px}}@media screen and (max-width: 720px){.r4f-ai-panel{top:auto;right:10px;bottom:82px}.r4f-ai-card{width:min(320px,calc(100vw - 20px))}}.r4f-overlay{position:fixed;z-index:999999;top:0;left:0;width:100vw;height:100vh;background:#0009;display:flex;justify-content:center;align-items:center}.r4f-modal{background:#121212;border-radius:8px;width:min(95vw,700px);height:min(90vh,900px);display:flex;flex-direction:column;overflow:hidden}.r4f-modal-header{flex:0 0 auto;padding:8px 12px}.r4f-modal-content{flex:1 1 auto;overflow-y:auto;padding:12px;min-height:0}.AppLayout{display:flex;height:100vh;color:#fff}li{margin-bottom:1rem;cursor:pointer}li:hover{background-color:#6592ed}.Content{flex:1;padding:2rem;overflow-y:auto}.sidenav{height:100%;width:360px;position:fixed;z-index:1;top:0;left:0;background-color:#111;color:#f1f1f1;overflow-x:hidden;padding-top:20px}.sidenav a{padding:6px 8px 6px 16px;text-decoration:none;font-size:25px;color:#818181;display:block}.sidenav a:hover{color:#f1f1f1}.main{margin-left:160px;font-size:28px;padding:0 10px}@media screen and (max-height: 450px){.sidenav{padding-top:15px}.sidenav a{font-size:18px}}.SelectedPlayer{margin-left:1rem;padding:0 1rem;background:#2615a5}.modal{display:none;position:fixed;z-index:1;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:#000;background-color:#0006}.modal-content{background-color:#060606;margin:15% auto;padding:20px;border:1px solid #888;width:80%}.close{color:#aaa;float:right;font-size:28px;font-weight:700}.close:hover,.close:focus{color:#f1f1f1;text-decoration:none;cursor:pointer}input[type=text]{background-color:#2d2c36;color:#fcfcfc;height:2.8em;padding:0 8px;border-radius:0;font-family:UltimateTeam,sans-serif}input::placeholder{color:#a6a6a1}.queue-container{display:flex;flex-direction:column;gap:1rem;padding:12px;max-width:600px;margin:0 auto;font-family:sans-serif}.original-queue-list{font-size:.5rem;color:#44334e}.queue-list{color:#060606;border:1px solid #ccc;padding:10px;border-radius:6px;background:#fafafa}.queue-list h4{margin:0 0 6px;font-size:1rem}.queue-items{display:flex;flex-wrap:nowrap;overflow-x:auto;gap:8px;padding-bottom:6px}.queue-item{padding:4px 6px;border:1px solid #ddd;border-radius:4px;min-width:120px;background:#fff;box-shadow:0 1px 2px #0000000d}.queue-controls{display:flex;gap:8px}.queue-controls button{padding:8px 12px;border-radius:4px;background:#5050ff;border:none;color:#fff;cursor:pointer;font-weight:600}.queue-controls button:last-child{background:#d9534f}.queue-controls button:hover{opacity:.85}.queue-controls button:disabled{background:#999;color:#eee;cursor:not-allowed;opacity:.6}.queue-controls button:disabled:hover{opacity:.6}.queue-checkbox{display:flex;align-items:center;gap:6px;font-weight:600;color:#fff}.queue-checkbox input{cursor:pointer}.queue-checkbox input:disabled{cursor:not-allowed}.queue-checkbox input:disabled+span,.queue-checkbox input:disabled~*{color:#aaa}.queue-checkbox input:disabled{opacity:.5}.manager-panel{color:#060606;border:1px solid #ccc;padding:12px;border-radius:6px;background:#fff;box-shadow:0 1px 3px #0000001f}.mini-card{position:relative;width:110px;height:150px;overflow:hidden;border-radius:8px;margin:4px;cursor:pointer;font-family:sans-serif}.mini-card-bg{position:absolute;width:100%;height:100%;object-fit:cover;z-index:1}.mini-card-face{position:absolute;width:90%;left:5%;bottom:5px;z-index:2}.mini-card-rating{position:absolute;top:6px;left:6px;z-index:3;font-size:20px;font-weight:700;color:#fff;text-shadow:0px 0px 4px black}.mini-card-position{position:absolute;top:32px;left:6px;z-index:3;font-size:14px;color:#fff;text-shadow:0px 0px 4px black}.mini-card-name{position:absolute;bottom:6px;text-align:center;width:100%;z-index:3;font-size:12px;color:#fff;text-shadow:0px 0px 4px black}.mini-card.selectable:hover{transform:scale(1.05);transition:.15s ease}.mini-card.selected{outline:3px solid #4f7cff;box-shadow:0 0 0 2px #4f7cff99,0 6px 18px #0006;transform:scale(1.05);z-index:2}.mini-card.selectable:hover{transform:scale(1.05)}.player-versions{display:flex;gap:12px;flex-wrap:nowrap;overflow-x:auto;padding-bottom:8px}.player-versions::-webkit-scrollbar{height:8px}.r4f-sell-price-label{display:block;text-align:center;font-size:11px;font-weight:600;color:#f0c040;padding:2px 4px;background:#000000a6;border-radius:0 0 4px 4px;margin-top:2px;letter-spacing:.3px}.r4f-sell-price-label.r4f-searching{color:#aaa}.r4f-sell-price-label.r4f-no-data,.r4f-sell-price-label.r4f-error{color:#f06060}.r4f-modal-item-row{display:flex;justify-content:space-between;align-items:center;padding:6px 4px;border-bottom:1px solid #2a2a2a;font-size:13px}.r4f-modal-item-row:last-child{border-bottom:none}.r4f-modal-item-name{color:#ccc}.r4f-modal-item-price{color:#f0c040;font-weight:600}.r4f-modal-item-skip{color:#888;font-style:italic}.r4f-modal-summary{padding:10px 4px;margin-bottom:8px;border-bottom:2px solid #333;font-size:14px;color:#fff}.r4f-modal-summary span{color:#f0c040;font-weight:700}.r4f-modal-footer{flex:0 0 auto;padding:10px 12px;display:flex;gap:10px;border-top:1px solid #333}.r4f-btn-confirm{flex:1;padding:10px;background:#2e7d32;border:none;border-radius:6px;color:#fff;font-weight:700;cursor:pointer;font-size:14px}.r4f-btn-confirm:hover{background:#388e3c}.r4f-btn-cancel{flex:1;padding:10px;background:#5a2020;border:none;border-radius:6px;color:#fff;font-weight:700;cursor:pointer;font-size:14px}.r4f-btn-cancel:hover{background:#7a2e2e}.r4f-modal-progress{padding:4px 4px 8px;font-size:12px;color:#aaa}
  ...
  const EXPECTED_BUNDLE_VERSION = "v7.7.14";
  const startupState = {
    failed: false,
    reason: null,
  };
